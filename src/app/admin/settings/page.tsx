          ...
          {activeTab === 'general' && (
            <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 space-y-5">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div><label className="block text-sm font-bold text-gray-300 mb-2">Seuil livraison gratuite ($)</label><input type="number" value={settings.free_shipping_threshold !== undefined && settings.free_shipping_threshold !== null ? settings.free_shipping_threshold : 100} onChange={e => updateSetting('free_shipping_threshold', +e.target.value)} className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-xl text-white text-sm focus:border-primary focus:outline-none"/></div>
                <div><label className="block text-sm font-bold text-gray-300 mb-2">Livraison Standard ($)</label><input type="number" step="0.01" value={settings.shipping_fee_standard !== undefined ? settings.shipping_fee_standard : 8.99} onChange={e => updateSetting('shipping_fee_standard', +e.target.value)} className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-xl text-white text-sm focus:border-primary focus:outline-none"/></div>
                <div><label className="block text-sm font-bold text-gray-300 mb-2">Livraison Express ($)</label><input type="number" step="0.01" value={settings.shipping_fee_express !== undefined ? settings.shipping_fee_express : 9.99} onChange={e => updateSetting('shipping_fee_express', +e.target.value)} className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-xl text-white text-sm focus:border-primary focus:outline-none"/></div>
                <div><label className="block text-sm font-bold text-gray-300 mb-2">Taux de taxe global (ex: 0.15)</label><input type="number" step="0.01" value={settings.tax_rate || 0.15} onChange={e => updateSetting('tax_rate', +e.target.value)} className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-xl text-white text-sm focus:border-primary focus:outline-none"/></div>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6 border-t border-gray-800 pt-6">
                <div className="col-span-full mb-2"><h3 className="font-bold text-white text-md">Offres de Volume (Réductions %)</h3><p className="text-gray-500 text-xs">Affiche "Achetez-en X pour -Y%" sur la page produit</p></div>
                <div><label className="block text-sm font-bold text-gray-300 mb-2">2 articles (-%)</label><input type="number" value={settings.vol_discount_2 !== undefined ? settings.vol_discount_2 : 15} onChange={e => updateSetting('vol_discount_2', +e.target.value)} className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-xl text-white text-sm focus:border-primary focus:outline-none"/></div>
                <div><label className="block text-sm font-bold text-gray-300 mb-2">3 articles (-%)</label><input type="number" value={settings.vol_discount_3 !== undefined ? settings.vol_discount_3 : 20} onChange={e => updateSetting('vol_discount_3', +e.target.value)} className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-xl text-white text-sm focus:border-primary focus:outline-none"/></div>
                <div><label className="block text-sm font-bold text-gray-300 mb-2">4 articles (-%)</label><input type="number" value={settings.vol_discount_4 !== undefined ? settings.vol_discount_4 : 25} onChange={e => updateSetting('vol_discount_4', +e.target.value)} className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-xl text-white text-sm focus:border-primary focus:outline-none"/></div>
                <div><label className="block text-sm font-bold text-gray-300 mb-2">5+ articles (-%)</label><input type="number" value={settings.vol_discount_5 !== undefined ? settings.vol_discount_5 : 35} onChange={e => updateSetting('vol_discount_5', +e.target.value)} className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-xl text-white text-sm focus:border-primary focus:outline-none"/></div>
              </div>
            </div>
          )}
          {activeTab === 'text' && (
